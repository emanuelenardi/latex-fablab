...
:::{.code .larger}
```{.txt code-line-numbers="|52-53|50-51|47-49|53|52|24|23|22|2|3-4|5-13|6-9|10-12|13|14|15|16-18|19-20|21|54|"}
.
├── assets/
│   ├── appendixes/
│   │   └── A*-appendix-name.tex
...
Codifica dei caratteri, impostazione della lingua, margini del documento, migliorare la scrittura

## Codifica dei caratteri {.smaller}

```{.latex code-line-numbers="|1|2|"}
...
## Margini del documento {.smaller}

::
```{.latex code-line-numbers="|1,8|2|3|4|5|6|7|"}
\usepackage[
    a4paper,
    % showframe,
    inner = 1.5cm,
...
```{.latex filename=tabularray-example.tex code-line-numbers="|2-4|6-12|7|8|9|10|11|13-19|"}
\begin{table}
    \centering
...
# Scrivere codice {#writing-code .smaller}
