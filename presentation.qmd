...
# Introduzione ai comandi {.smaller}
...
% arara: biber if missing('bbl') || changed('bbl') || found('log', 'Citation')
...
## Special LaTeX characters {.smaller}

some characters are reserved for LaTeX commands. They cannot be used directly in the source. Usually they can be printed if preceded by a backslash:
