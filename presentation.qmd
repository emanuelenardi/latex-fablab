...
:::{.code .larger}
```{.latex filename=".araraconfig.yaml" code-line-numbers="|1-5|7-8|10-11|13-17|19-20"}
% arara: pdflatex: {
% arara: --> draft: yes,
% arara: --> shell: yes,
...
# Struttura del progetto {.smaller #project-structure data-background-image="assets/images/hero/project-structure.jpg" data-background-size="cover"}
