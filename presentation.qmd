...
### Come agggiungere un didascalia {.smaller}
...
```
Ora possiamo aggiungere `\listoflistings` nel punto in cui vogliamo che venga generato l'elenco dei codici, generalmente dopo `\listoffigures` e `\listoftables`.
