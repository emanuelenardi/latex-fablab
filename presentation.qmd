...
:::
::: {.column width="33%"}
![Timothee Chalamet](assets/images/pronunciation/Timothee-Chalamet-latex.webp){fig-align="center" height="450px"}
:::
::::
...
## Powertoys {{< fa brands windows >}} {#powertoys .smaller}
...
| Strumento | Shortcut |
|---------|:-----|
| Incollaggio avanzato | {{< fa brands windows >}} `+ shift + V` |
| Selezione colori | {{< fa brands windows >}} `+ shift + C` |
| FancyZones | {{< fa brands windows >}} `+ shift + ò` |
| Componenti aggiuntivi File Explorer | 
| Quick Accent |  |
| Righello schermo | {{< fa brands windows >}} `+ shift + M` |
...
## Il pacchetto `tabularray` {.smaller #package-tabularray-example}
...
### Esempio {.smaller #package-tabularray-example}
...
# Scrivere codice {.smaller #writing-code}
...
# La bibliografia {.smaller #bibliography}

Creazione, gestione e personalizzazione della bibliografia.

## Come creare un bibliografia {#crezione-bibliografia .smaller}
...
## Come fare una citazione {.smaller}
...
## Opzioni di stile della bibliografia {#biblatex-options .smaller}
...
## Differenze fra Overleaf e VSCode {.smaller}
...
## Il package glossaries {.smaller #package-glossaries}
